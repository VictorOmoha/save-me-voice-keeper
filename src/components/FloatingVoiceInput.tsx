...
export const FloatingVoiceInput: React.FC<FloatingVoiceInputProps> = ({
  ...
  const handleVoiceInput = async (transcript: string) => {
    logVoice('FloatingVoiceInput: Direct voice input to dashboard:', transcript);
    if (!onEnhancedVoiceInput) {
      logWarn('FloatingVoiceInput: No onEnhancedVoiceInput handler provided. Ignoring transcript.');
      return;
    }
