...
> **Status disclaimer.** This is an engineering evidence inventory to support Victor's decision **D-003** (deletion/export/retention semantics, due Aug 10) and Sentinel Security review. Every *export* and *delete* action below is a clearly-marked **PROPOSAL** — no deletion, export, retention, or cancellation behavior is implemented or implied by this document. M0 produces decisions and contracts only; no production behavior changes.
