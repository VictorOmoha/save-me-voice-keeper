    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <ul>
            <li><strong>Firebase:</strong> Stores your user data and content, provides authentication</li>
          ...
          <ul>
            ...
            <li><strong>Infrastructure:</strong> Hosted on secure cloud providers (Firebase, Google Cloud)</li>
          </ul>
          ...
          <div className="mt-12 p-6 bg-muted rounded-lg">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><strong>Data Sharing:</strong> Only with service providers (Firebase, 11Labs, Stripe) - we NEVER sell data</li>
