 ...
 */
export const logWarn = (message: string, data?: any, options?: LogOptions): void => {
  const formatted = formatMessage(message, options);
  if (data !== undefined) {
 ...
 */
export const logVoice = (message: string, data?: any): void => {
 ...
 */
export const logDashboard = (message: string, data?: any): void => {
 ...
 */
export const logForm = (message: string, data?: any): void => {
 ...
 */
export const logStorage = (message: string, data?: any): void => {
 ...
 */
export const logPrint = (message: string, data?: any): void => {
