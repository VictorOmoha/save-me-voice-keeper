import { a as reactExports, t as useDirection, d as useControllableState, j as jsxRuntimeExports, v as Root, P as Primitive, u as useComposedRefs, I as Item, f as composeEventHandlers, w as createRovingFocusGroupScope, e as Presence, m as createContextScope, x as usePrevious, y as useSize } from "./vendor-ui-CLSr_GWM.js";
import { i as cn, D as Download, B as Button, J as Jt, o as ChevronDown, F as FileText } from "./index-CT7EzYyk.js";
import { k as Circle, i as Checkbox, P as Printer, a as DropdownMenu, b as DropdownMenuTrigger, c as DropdownMenuContent, d as DropdownMenuItem, e as DropdownMenuSeparator } from "./EntryViewDialog-p97oVngN.js";
import { B as Badge } from "./badge-CRUpIyW6.js";
import { I as Input } from "./input-B1KmmYia.js";
import { L as Label } from "./label-Leg8N3DR.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, e as DialogFooter } from "./dialog-qADkFQn2.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CyBQ8QTa.js";
import { E } from "./jspdf.es.min-iF735MOB.js";
import { openPrintPreview, printEntries } from "./printUtils-DS2c1ZUl.js";
import { E as Eye } from "./user-CWEc4l4g.js";
...
const exportToCSV = (entries, filename = "form-data") => {
  if (entries.length === 0) {
...
const exportEntries = async (entries, options) => {
  if (entries.length === 0) {
    throw new Error("No data to export");
  }
...
const exportToJSON = (entries, filename, includeMetadata) => {
...
const exportToPDF = (entries, filename, includeMetadata) => {
  const doc = new E();
  doc.setFontSize(20);
  doc.text("Exported Data", 20, 20);
  doc.setFontSize(10);
  doc.text(`Exported on: ${(/* @__PURE__ */ new Date()).toLocaleDateString()}`, 20, 30);
  const allFieldNames = /* @__PURE__ */ new Set();
  entries.forEach((entry) => {
    Object.keys(entry.fields).forEach((field) => {
      allFieldNames.add(field);
...
const exportToExcel = (entries, filename, includeMetadata) => {
  const allFieldNames = /* @__PURE__ */ new Set();
  entries.forEach((entry) => {
    Object.keys(entry.fields).forEach((field) => {
      allFieldNames.add(field);
...
const exportToHTML = (entries, filename, includeMetadata) => {
  const allFieldNames = /* @__PURE__ */ new Set();
  entries.forEach((entry) => {
    Object.keys(entry.fields).forEach((field) => {
      allFieldNames.add(field);
...
<body>
    <div class="header">
        <h1>Exported Data</h1>
        <p class="export-date">Exported on: ${(/* @__PURE__ */ new Date()).toLocaleDateString()}</p>
    </div>
...
const ExportModal = ({
  ...
  const [filename, setFilename] = reactExports.useState("form-data");
  ...
  const entriesToExport = selectedEntries.length > 0 ? entries.filter((entry) => selectedEntries.includes(entry.id)) : entries;
  const handleExport = async () => {
    if (entriesToExport.length === 0) {
      Jt.error("No entries to export");
      return;
    }
    setIsExporting(true);
    try {
      ...
      Jt.success(`Successfully exported ${entriesToExport.length} entries as ${getExportFormatName(exportFormat)}`);
      onClose();
    } catch (error) {
      console.error("Export error:", error);
      Jt.error("Failed to export entries");
    } finally {
  ...
  const handlePrint = () => {
    ...
    Jt.success(`Sent ${entriesToExport.length} entries to printer`);
  };
  const handlePrintPreview = () => {
    if (entriesToExport.length === 0) {
      Jt.error("No entries to preview");
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-5 w-5" }),
      "Export & Print Options"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-muted rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "Ready to export" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: selectedEntries.length > 0 ? "Selected Items" : "All Items" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-base font-medium", children: "Export Format" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroup, { value: exportFormat, onValueChange: (value) => setExportFormat(value), children: exportFormats.map((format) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3 p-3 border rounded-lg hover:bg-muted/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: format.value, id: format.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: format.value, className: "flex items-center gap-2 cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: getExportFormatIcon(format.value) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: format.label })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: format.description })
          ] })
        ] }, format.value)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-base font-medium", children: "Export Options" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "filename", children: "Filename" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "filename",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "include-metadata", children: "Include metadata (creation date, last modified, etc.)" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-base font-medium flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "h-4 w-4" }),
          "Print Options"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "font-size", children: "Font Size" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                value: printOptions.fontSize,
                onValueChange: (value) => setPrintOptions((prev) => ({ ...prev, fontSize: value })),
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
                  ...
                  onCheckedChange: (checked) => setPrintOptions((prev) => ({ ...prev, includeMetadata: checked }))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "print-metadata", children: "Include metadata" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
                  ...
                  onCheckedChange: (checked) => setPrintOptions((prev) => ({ ...prev, pageBreakBetweenEntries: checked }))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "page-breaks", children: "Page break between entries" })
            ] })
          ] })
        ] })
      ] })
...
const ExportButton = ({
  ...
  const handleQuickExport = async (format) => {
    ...
    try {
      ...
      Jt.success(`Successfully exported ${entriesToExport.length} entries as ${getExportFormatName(format)}`);
    } catch (error) {
      console.error("Export error:", error);
      Jt.error("Failed to export entries");
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant, size, disabled: isDisabled, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
        showLabel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", children: "Export" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4 ml-1" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-56", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-sm font-medium border-b", children: "Quick Actions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => handleQuickExport("csv"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: getExportFormatIcon("csv") }),
          "Export as CSV"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => handleQuickExport("json"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: getExportFormatIcon("json") }),
          "Export as JSON"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => handleQuickExport("pdf"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: getExportFormatIcon("pdf") }),
          "Export as PDF"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: handlePrintPreview, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4 mr-2" }),
          "Print Preview"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: handleQuickPrint, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "h-4 w-4 mr-2" }),
          "Quick Print"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setShowExportModal(true), children: [
