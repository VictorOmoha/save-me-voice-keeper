...
function getBytes$1(service, location2, maxDownloadSizeBytes) {
...
function getBlobInternal(ref2, maxDownloadSizeBytes) {
  ...
  const requestInfo = getBytes$1(ref2.storage, ref2._location);
  return ref2.storage.makeRequestWithTokens(requestInfo, newBlobConnection).then((blob) => blob);
}
...
export {
  ...
  getDownloadURL as C,
  writeBatch as D,
  EmailAuthProvider as E,
  reauthenticateWithCredential as F,
  ...
  initializeApp as i,
  createUserWithEmailAndPassword as j,
  signInWithEmailAndPassword as k,
  getDoc as l,
  setDoc as m,
  serverTimestamp as n,
  onAuthStateChanged as o,
  collection as p,
  addDoc as q,
  deleteDoc as r,
  sendPasswordResetEmail as s,
  query as t,
  updateProfile as u,
  getDocs as v,
  where as w,
